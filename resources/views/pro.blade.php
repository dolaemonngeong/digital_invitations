	...
	<section id="header">
		<header class="major">
			...
			<div onclick="toggleAudio()" id="music-button" style="z-index: +40; background: none; cursor:pointer; position:fixed; top:3vh; right:3vw;">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" filter="drop-shadow(0 0 10px #9d822b)">
					<rect x="3" y="4" width="3" height="16" fill="white">
						<animate attributeName="height" values="16;20;16" dur="1s" repeatCount="indefinite" />
					</rect>
					<rect x="9" y="1" width="3" height="19" fill="white">
						<animate attributeName="height" values="19;23;19" dur="1.2s" repeatCount="indefinite" />
					</rect>
					<rect x="15" y="4" width="3" height="16" fill="white">
						<animate attributeName="height" values="16;25;16" dur="1.4s" repeatCount="indefinite" />
					</rect>
					<rect x="21" y="1" width="3" height="19" fill="white">
						<animate attributeName="height" values="19;23;19" dur="1.6s" repeatCount="indefinite" />
					</rect>
				</svg>
			</div>
    ...
    <section id="two" class="main special">
		<div class="container">
			...
			<div class="content">
                ...
                <div id="timer" style="font-size: 24px; color: #000000;"></div>
			</div>
	...
	<section id="two" class="main special">
		<div class="container">
			...
			<div class="content">
				...
				<ul class="actions special">
					<li>
						<a href="#two" class="button primary scrolly" id="openModalBtn">Open</a>
					</li>
				</ul>
			</div>
			<a href="#three" class="goto-next scrolly">Next</a>
